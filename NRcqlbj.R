...
#####################################################
##### Newton-Raphson iteration: conditional inference based on BJ ######

CQL_bj=function(beta_h0,v_h0){
  ...
  { 
    ...
    Wi_exp0=Wi_1*expeta_h0;  #### N*D matrix
    Wx_exp0=Wi_x1*expeta_h0;  #### N*D matrix
    co_Wi0=colSums(Wi_exp0);  #### D*1 vector
    co_Wx0=colSums(Wx_exp0);  #### D*1 vector
    co_Wxs0=colSums(Wi_x1s*expeta_h0);  #### D*1 vector
  ...
  ######## estimate of Q_b ##########
  Qb_k=colSums(M_ero_cg*xi_b1);   ### D_c*1 vector
  ##### final estiamtor of 2nd part of xi_b ######
  xi_b21=Qb_k/n_ero;  ### D_c*1 vector
  xi_b2=colSums(xi_b21*dM_ero_hat);  ### N*1 vector
